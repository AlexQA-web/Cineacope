...
class DataGenerator:
    ...
    def generate_random_password():
        ...
        password = list(upper_letter + lower_letter + digit + remaining_chars)
    ...
    def query_params():
        ...
        return {
            ...
            "minPrice": random.randint(1, 1000),
            "locations": random.choice(city_list),
            "published": True,
